...
class ControllerExtensionModuleWebinewsletter extends Controller {
	...
	public function index($setting) {
		...
		$config_theme = $this->config->get('theme_remart_directory');
		...
		if (file_exists(DIR_TEMPLATE . $config_theme  . '/stylesheet/webinewsletter.css')) {
			...
			$this->document->addStyle('catalog/view/theme/remart/stylesheet/webinewsletter.css');
		}
		...
		$this->mdata['mode']        = isset($setting['displaymode']) ? $setting['displaymode'] : "remart";
